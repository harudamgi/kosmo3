...
public class TenantMainView extends JPanel {

	JTable farm_table;
	
	public TenantMainView() {
		addLayout();
	}
	...
	void addLayout() {
		...
		JLabel label_landlord_1 = new JLabel("대여 중인 농장 목록");
		...
		JButton btn_select_farm = new JButton("");
		btn_select_farm.setFont(new Font("한컴산뜻돋움", Font.PLAIN, 12));
		btn_select_farm.setBounds(82, 185, 100, 25);
		add(btn_select_farm);
		
		
		JButton btn_payment = new JButton("");
		btn_payment.setFont(new Font("한컴산뜻돋움", Font.PLAIN, 12));
		btn_payment.setBounds(232, 185, 100, 25);
		add(btn_payment);
